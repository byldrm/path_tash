...
class BasketRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Basket $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Basket $entity, bool $flush = true): void
    {
...
/*    public function getBasket($term)
    {
        return $this->createQueryBuilder('basket')
            ->andWhere('basket.userId = :searchTerm
